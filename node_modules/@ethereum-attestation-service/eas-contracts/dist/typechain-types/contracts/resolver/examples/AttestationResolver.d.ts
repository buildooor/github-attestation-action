...
export interface AttestationResolverInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "VERSION" | "attest" | "isPayable" | "multiAttest" | "multiRevoke" | "revoke" | "toBytes32"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "toBytes32", values: [PromiseOrValue<BytesLike>, PromiseOrValue<BigNumberish>]): string;
...
export interface AttestationResolver extends BaseContract {
    ...
    functions: {
        ...
        toBytes32(data: PromiseOrValue<BytesLike>, start: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string]>;
    };
    VERSION(overrides?: CallOverrides): Promise<string>;
    attest(attestation: AttestationStruct, overrides?: PayableOverrides & {
        from?: PromiseOrValue<string>;
    ...
    estimateGas: {
        ...
        toBytes32(data: PromiseOrValue<BytesLike>, start: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        ...
        toBytes32(data: PromiseOrValue<BytesLike>, start: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
//# sourceMappingURL=AttestationResolver.d.ts.map