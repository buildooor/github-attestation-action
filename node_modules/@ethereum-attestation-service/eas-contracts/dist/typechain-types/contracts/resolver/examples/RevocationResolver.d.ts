...
export interface RevocationResolverInterface extends utils.Interface {
    functions: {
        ...
        "setRevocation(bool)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "VERSION" | "attest" | "isPayable" | "multiAttest" | "multiRevoke" | "revoke" | "setRevocation"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "setRevocation", values: [PromiseOrValue<boolean>]): string;
    ...
    decodeFunctionResult(functionFragment: "setRevocation", data: BytesLike): Result;
    events: {};
}
export interface RevocationResolver extends BaseContract {
    ...
    functions: {
        ...
        setRevocation(status: PromiseOrValue<boolean>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    VERSION(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        setRevocation(status: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
...
//# sourceMappingURL=RevocationResolver.d.ts.map